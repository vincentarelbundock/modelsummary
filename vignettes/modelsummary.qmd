...
If the vector is named, the values of this vector correspond to new variable labels as they will appear in the output table (so, if `coef_rename` equals `TRUE`, the variables are basically renamed two times).
