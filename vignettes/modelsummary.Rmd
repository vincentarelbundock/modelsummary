...
```{r, eval = FALSE}
options(modelsummary_default = "latex")
options(modelsummary_default = "gt")
```
...
options(modelsummary_latex = 'flextable')
...
data(trade)
mod <- fepois(Euros ~ log(dist_km) | Origin + Destination + Product + Year, data = trade)
