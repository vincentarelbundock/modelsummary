...
2. The string "rbind" to stack multiple tables on top of each other and present models in distinct "panels".
...
### "rbind": Panels of models in stacked regression tables
