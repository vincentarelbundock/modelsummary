...
You could also use fancy [look-ahead or look-behind assertions](https://en.wikipedia.org/wiki/Perl_Compatible_Regular_Expressions#Look-ahead_and_look-behind_assertions). For example, if you want the *opposite* of `coef_omit` (call it `coef_keep`), and you want to "keep" parameters that match a certain pattern, you could try:
