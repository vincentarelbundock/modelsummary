...
test_that("multi vcov with model recycling", {
    ...
    expect_equal(tab[["I"]], "11.929")
    expect_equal(tab[["II"]], "12.120")
    expect_equal(tab[["III"]], "43.502")
})
...
test_that("hardcoded numerical", {
    ...
    tab <- modelsummary(mod,
        ...
        vcov = c(
            ...
            "drat" = 3,
            "hp" = 2))
    expect_equal(tab[["I"]], c("9.000", "2.000", "3.000"))
})
