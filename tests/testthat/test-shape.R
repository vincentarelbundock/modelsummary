...
test_that("nnet::multinom: order of rows determined by formula terms", {
    ...
    expect_equal(colnames(tab),
                 c("part", "response", "term", "statistic", "I", "II"))
    ...
    expect_s3_class(tab, "data.frame")
    expect_equal(colnames(tab),
                 c("part", "term", "response", "statistic", "I", "II"))
    ...
    expect_equal(tab$model[1:10], c(rep("I", 4), rep("II", 6)))
    ...
    expect_equal(tab$model[1:3], c("I", "I", "II"))
...
test_that("grouped coefficients: gamlss", {
    ...
    expect_s3_class(tab, "data.frame")
    expect_equal(colnames(tab),
                 c("part", "term", "component", "statistic", "I", "II"))

    tab <- modelsummary(mod, "data.frame", shape = component + term ~ model)
    expect_s3_class(tab, "data.frame")
    expect_equal(colnames(tab),
                 c("part", "component", "term", "statistic", "I", "II"))
