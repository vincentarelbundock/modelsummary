...
You will find that there are a million ways to customize the tables and plots produced by `modelsummary`, but [the Get Started page](vignettes/get_started.html) only scratches the surface. For details, see the vignettes:
